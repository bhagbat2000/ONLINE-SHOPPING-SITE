    ...
    <div class="row">
      ...
      <div class="col-md-8">
        <div class="jumbotron p-3 mt-5">
          ...
          $sql = "select * from furniture where category='$v'";
          ...
          if (mysqli_num_rows($result) > 0) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
              ...
              if ($type == ($row["types"])) {
                ...
                if($row["category"]<=8)
                print("<a  href=3rd_page.php?w=" . $row["types"] . "><img src=image/all/" . $row["types"] . ".jpg" . " class='rounded img-fluid'></a>");
                else
                print("<a  href=3rd_page.php?w=" . $row["types"] . "><img src=image/all/" . $row["types"] . ".jpeg" . " class='rounded img-fluid'></a>");
                $type++;
                $cnt++;
                echo "<a style='color:#FFFFFF' href=3rd_page.php?w=" . $row["types"] . ">" . $row["type_name"] . "</a>";
                echo "</div>";
                echo "</div>";
              }
